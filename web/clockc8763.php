...
<svg width="{$bgdX}" height="{$bgdY}" version="1.1"
	...
	<image herf="https://cies96035.herokuapp.com/img/CL/H.png" height="{$HL}" width="200" x="200" y="160">
		<animateTransform dur="43200s" attributeName="transform" repeatCount="indefinite" type="rotate" from="{$HD},{$PX},{$PY}" to="{$HDe},{$PX},{$PY}"/>
	</image>
	
	<image herf="https://cies96035.herokuapp.com/img/CL/M.png" height="{$ML}" width="200" x="200" y="120">
		<animateTransform dur="3600s" attributeName="transform" repeatCount="indefinite" type="rotate" from="{$MD},{$PX},{$PY}" to="{$MDe},{$PX},{$PY}"/>
	</image>
	
	<image herf="https://cies96035.herokuapp.com/img/CL/S.png" height="{$SL}" width="200" x="200" y="60">
		<animateTransform dur="60s" attributeName="transform" repeatCount="indefinite" type="rotate" from="{$SD},{$PX},{$PY}" to="{$SDe},{$PX},{$PY}"/>
	</image>

	<image herf="https://cies96035.herokuapp.com/img/CL/p.png" height="60" width="60" x="270" y="270"/>
</svg>
SVG;
?> 
